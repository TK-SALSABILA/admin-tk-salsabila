import ModalCreateClass from '@/components/modal/ModalClassForm';
...
const ClassListFIlter = () => {
  ...
  return (
    <div className='flex justify-end gap-2'>
      <ReusableFilter filters={[]} searchConfig={{placeholder: "Cari Kelas", searchKey: "search"}} />
      <ButtonOpenModal onClick={() => setOpen(true)} text="Tambah Kelas" iconPosition='left'/>
